...
public class fPost2 extends VerticalLayout{
    ...
    public fPost2(){
        ...
        H6 aboutText1 = new H6("Hi, " + post2.get("user") + "! Nice to meet you!");
        ...
        H6 commentText1 = new H6("Yeah we know");
        ...
        H6 commentText2 = new H6("Definitely a website");
        ...
        H6 commentText3 = new H6("Website indeed");
